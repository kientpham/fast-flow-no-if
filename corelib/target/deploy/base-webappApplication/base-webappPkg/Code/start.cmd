...
set APP_HEAP_DUMP_PATH=C:\tbh\logs\memory\base-webapp
mkdir %APP_HEAP_DUMP_PATH%
set APP_HEAP_FILE=%APP_HEAP_DUMP_PATH%\base-webapp_%timestamp%.hprof


set OMS_LOG_FILE=%OMS_LOG_PATH%\base-webapp-setup.log
...
set SERVICE_NAME_PARAM=-DSERVICE_NAME=base-webapp
set ENVIRONMENT_PARAM=-DENVIRONMENT=%ENVIRONMENT%
set LOG4J2_CONFIG_PARAM=-Dlogging.config=%Fabric_Folder_Application%/base-webappPkg.Config.0.0.1-SNAPSHOT/log4j2-system.xml
...
java %AI_AGENT% %HOSTNAME_AGENT% %FAST_FAIL_PARAM% %LOGGING_PATH_PARAM% %SERVICE_NAME_PARAM% %LOG4J2_CONFIG_PARAM% %ENVIRONMENT_PARAM% %XMX_PARAM% %XMS_PARAM% %MAX_METASPACE_PARAM% %HEAP_DUMP_PATH% %HEAP_DUMP_OUT_OF_MEM% %NO_WINDOWS_DUMP% %EUREKA_DISCOVERY_OPTS% %JVMOPTS% -jar base-webapp-0.0.1-SNAPSHOT.jar
